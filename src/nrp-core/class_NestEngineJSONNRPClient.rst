.. index:: pair: class; NestEngineJSONNRPClient
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client:
...
NRP - Nest Communicator on the NRP side. Converts :ref:`DataPackInterface <doxid-class_data_pack_interface>` classes from/to JSON objects. :ref:`More...<details-class_nest_engine_j_s_o_n_n_r_p_client>`


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <nest_engine_json_nrp_client.h>
	
	class NestEngineJSONNRPClient: public :ref:`EngineJSONNRPClient<doxid-class_engine_j_s_o_n_n_r_p_client>` {
	public:
		// construction
	
		:target:`NestEngineJSONNRPClient<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a8b4b9fb29816123a9417e13a7efcd661>`(
		...
		virtual void :ref:`initialize<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a1cc74c30fce4b16d285d078ca06b7ed5>`();
		virtual void :ref:`reset<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a99d40b960efa2155bfd65e7638a1c676>`();
		virtual void :ref:`shutdown<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1adcc67a7d1db9a723bba42eaaa5731f08>`();
		virtual const std::vector<std::string> :ref:`engineProcStartParams<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1aee6606bbd80d34522082dfc3d163dbc0>`() const;
		virtual const std::vector<std::string> :ref:`engineProcEnvParams<doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a16b83559056cf11e9774a0450a11c9c9>`() const;
	};
...
.. _details-class_nest_engine_j_s_o_n_n_r_p_client:
...
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a1cc74c30fce4b16d285d078ca06b7ed5:
...
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a99d40b960efa2155bfd65e7638a1c676:
...
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client_1adcc67a7d1db9a723bba42eaaa5731f08:
...
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client_1aee6606bbd80d34522082dfc3d163dbc0:
...
.. _doxid-class_nest_engine_j_s_o_n_n_r_p_client_1a16b83559056cf11e9774a0450a11c9c9:
