.. index:: pair: class; NRPExceptionRecoverable
.. _doxid-class_n_r_p_exception_recoverable:
...
.. ref-code-block:: cpp
	...
	class NRPExceptionRecoverable: public :ref:`NRPException<doxid-class_n_r_p_exception>` {
	public:
		// construction
	
		template <class T>
		:target:`NRPExceptionRecoverable<doxid-class_n_r_p_exception_recoverable_1af072c97b32691290957be0505a3acbd7>`(T&& msg, bool msgLogged = false);
	};
