.. index:: pair: class; InputDummy
.. _doxid-class_input_dummy:
...
Dummy input node which always sends the same msg upon request. :ref:`More...<details-class_input_dummy>`
...
.. ref-code-block:: cpp
	...
	class InputDummy: public :ref:`InputNode<doxid-class_input_node>` {
	public:
		// construction
	
		:target:`InputDummy<doxid-class_input_dummy_1aea4828cdff073a5bca8a9ecb34934b4b>`(const std::string& id, boost::python::object value);

		// methods
	
		virtual void :ref:`configure<doxid-class_input_dummy_1ac6b052e01a05fdcc6bedfaf22af44d44>`();
	};
...
.. _doxid-class_input_dummy_1ac6b052e01a05fdcc6bedfaf22af44d44:
