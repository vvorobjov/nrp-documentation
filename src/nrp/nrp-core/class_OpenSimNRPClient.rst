.. index:: pair: class; OpenSimNRPClient
.. _doxid-class_open_sim_n_r_p_client:

class OpenSimNRPClient
======================
...
.. ref-code-block:: cpp
	...
	#include <opensim_nrp_client.h>
	
	class OpenSimNRPClient: public :ref:`PythonEngineJSONNRPClientBase<doxid-class_python_engine_j_s_o_n_n_r_p_client_base>` {
	public:
		// construction
	
		:target:`OpenSimNRPClient<doxid-class_open_sim_n_r_p_client_1a1dc5df8f5bd4c8663a394e3ca2be8eed>`(
