...
Then you need to browse the template experiments and clone the one called "Tutorial: Brain Visualizer". You can use the filter to find it easily.

Download first the files you will need later in this tutorial :download:`files.zip <files.zip>`
