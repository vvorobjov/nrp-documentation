...
# handled by the upper level build process
...
#import hbp_sphinx_theme #removed by FOM
#html_theme = "hbp_sphinx_theme" #removed by FOM
#html_theme_path = [hbp_sphinx_theme.get_html_theme_path()] #removed by FOM
...
# of the sidebar.
#html_logo = 'HBP_Horizontal_RGB_BlackText68px.png'
...
# the title page.
#latex_logo = 'HBP_Primary_RGB_logoOnly.png'
latex_logo = '../../lib/hbpdoc/_assets/HBP_Horizontal_RGB_BlackText.png'
...
epub_title = title
epub_author = authors
epub_publisher = u'Human Brain Project'
